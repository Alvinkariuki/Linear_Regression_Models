...
# Code Commented out does not in general affect the processes taking place on the data
...
"""
    Visualize Data set
    plt.scatter(X,y)
    plt.title('Brain Size vs Brain Weight')
...
# Classic gradient_descent

theta, J_history = cfx.gradient_descent(X, y, theta)
print(theta)
...
_ = ax.plot(range(200), J_history[:200], 'b.')
plt.show()
"""
